        ...
        <div class="container pt-1">
            <div class="row py-3 align-content-center">
                <div class="col-12 col-md-3 col-xl-2 text-center text-md-start pb-2" id="header-logo">
                    <a href="./index.html">
                        <img src="assets/images/logo.png" alt="">فروشگاه طلا
                    </a>
                </div>
                                ...
                                <div class="droopmenu-nav-wrap">
                                    <div class="droopmenu-navi">
                                        <ul class="droopmenu">
                                            ...
                                            <li><a href="galery.php">گالری طلا<em class="droopmenu-topanim"></em></a></li>
                                            <li><a href="#">تماس با ما<em class="droopmenu-topanim"></em></a></li>
                                            <li><a href="#">مقالات<em class="droopmenu-topanim"></em></a></li>
                                            <?php if (isset($_SESSION['login'])) { ?>
                ...
                <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/images/slider/Photostore.jpg" class="d-block" alt="..." style="height: 416px;width: 1500px;">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/images/slider/2-2.jpg" class="d-block" alt="..." style="height: 416px;width: 980px;">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="product-box">
                            ...
                            <div class="details p-3">
                                <div class="category">
                                    <a href="product.php?idProduct=<?=$productStar['id'] ?>">گوشواره</a>
                                </div>
                ...
                <?php  foreach ($mostVISTED as $mostVISTE) {?>
                    <div class="col">
                        ...
                        <div class="product-box">
                            ...
                            <div class="details p-3">
                                <div class="category">
                                    <a href="product.php?idProduct=<?=$mostVISTE['id'] ?>">گوشواره</a>
                                </div>
...
<section id="most-sales-products" class="pt-4">
    ...
    <div class="container pt-4">
        ...
        <div class="row pb-2 pb-sm-4">
            <div class="col-12 text-center">
                <div class="btn-group" role="group" id="most-sales-products-nav">
                    <button type="button" class="btn active most-sales-categories" data-val="mobile">سرویس طلا</button>
                    <button type="button" class="btn most-sales-categories" data-val="laptop">گوشواره</button>
                    <button type="button" class="btn most-sales-categories" data-val="computer">النگو</button>
                    <button type="button" class="btn most-sales-categories" data-val="camera">انگشتر</button>
                </div>
            </div>
        </div>
        <!-- /Tabs -->
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 most-sales-product mobile" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="col">
                ...
                <div class="product-box">
                    ...
                    <a href="./product.html"><div class="image" style="background-image: url('../admin/images/<?=$service['image'] ?>')"></div></a>
                    <div class="icons">
                        <div class="btn btn-outline-secondary btn-favorite"></div>
                        <div class="btn btn-outline-secondary btn-compare"></div>
                    </div>
                    <div class="details p-3">
                        <div class="category">
                            <a href="product.php?idProduct=<?=$service['id'] ?>">سرویس طلا</a>
                        </div>
                        <a href="product.php?idProduct=<?=$service['id'] ?>"><h2><?=$service['name'] ?></h2></a>
                        <div class="price"><?=$service['price'] ?> تومان</div>
                        <div class="rate">
                            <i class="fa fa-star-half-alt"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 most-sales-product laptop" data-aos="fade-up" data-aos-duration="1000">
            <?php
            if ($gooshvares->rowCount() > 0) { ?>
                <?php  foreach ($gooshvares as $gooshvare) {?>
                    <div class="col">
                        <!-- Product Box -->

                        <div class="product-box">

                            <a href="product.php?idProduct=<?=$gooshvare['id'] ?>"><div class="image" style="background-image: url('../admin/images/<?=$gooshvare['image'] ?>')"></div></a>
                            <div class="icons">
                                <div class="btn btn-outline-secondary btn-favorite"></div>
                                <div class="btn btn-outline-secondary btn-compare"></div>
                            </div>
                            <div class="details p-3">
                                <div class="category">
                                    <a href="product.php?idProduct=<?=$gooshvare['id'] ?>">گوشواره</a>
                                </div>
                                <a href="product.php?idProduct=<?=$gooshvare['id'] ?>"><h2><?=$gooshvare['name'] ?></h2></a>
                                <div class="price"><?=$gooshvare['price'] ?> تومان</div>
                                <div class="rate">
                                    <i class="fa fa-star-half-alt"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 most-sales-product computer" data-aos="fade-up" data-aos-duration="1000">
            <?php
            if ($alangoos->rowCount() > 0) { ?>
                <?php  foreach ($alangoos as $alangoo) {?>
                    <div class="col">
                        <!-- Product Box -->

                        <div class="product-box">

                            <a href="product.php?idProduct=<?=$alangoo['id'] ?>"><div class="image" style="background-image: url('../admin/images/<?=$alangoo['image'] ?>')"></div></a>
                            <div class="icons">
                                <div class="btn btn-outline-secondary btn-favorite"></div>
                                <div class="btn btn-outline-secondary btn-compare"></div>
                            </div>
                            <div class="details p-3">
                                <div class="category">
                                    <a href="product.php?idProduct=<?=$alangoo['id'] ?>">النگو</a>
                                </div>
                                <a href="product.php?idProduct=<?=$alangoo['id'] ?>"><h2><?=$alangoo['name'] ?></h2></a>
                                <div class="price"><?=$alangoo['price'] ?> تومان</div>
                                <div class="rate">
                                    <i class="fa fa-star-half-alt"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 most-sales-product camera" data-aos="fade-up" data-aos-duration="1000">
            ...
            <?php
            if ($anoshtars->rowCount() > 0) { ?>
                <?php  foreach ($anoshtars as $anoshtar) {?>
                    <div class="col">
                        <!-- Product Box -->

                        <div class="product-box">

                            <a href="product.php?idProduct=<?=$anoshtar['id'] ?>"><div class="image" style="background-image: url('../admin/images/<?=$anoshtar['image'] ?>')"></div></a>
                            <div class="icons">
                                <div class="btn btn-outline-secondary btn-favorite"></div>
                                <div class="btn btn-outline-secondary btn-compare"></div>
                            </div>
                            <div class="details p-3">
                                <div class="category">
                                    <a href="product.php?idProduct=<?=$anoshtar['id'] ?>">انگشتر</a>
                                </div>
                                <a href="product.php?idProduct=<?=$anoshtar['id'] ?>"><h2><?=$anoshtar['name'] ?></h2></a>
                                <div class="price"><?=$anoshtar['price'] ?> تومان</div>
                                <div class="rate">
                                    <i class="fa fa-star-half-alt"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
